...
function 0x1b22(uint256 varg0, uint256 varg1, uint256 varg2, uint256 varg3) private { 
    ...
    if (!v7) {
        ...
        _products[_products.length + 1 - 1].field0 = v10.word0;
        v13 = v10.word1;
        require(v13.length <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
        v14 = 0x3f0e(_products[_products.length + 1 - 1].length);
        if (v14 > 31) {
            v15 = v16 = _products[_products.length + 1 - 1].data;
            v15 = v17 = v16 + (v13.length + 31 >> 5);
            while (v15 < v16 + (v14 + 31 >> 5)) {
                STORAGE[v15] = STORAGE[v15] & 0x0 | uint256(0);
                v15 = v15 + 1;
            }
        }
        v18 = v19 = 32;
        if (v13.length > 31 == 1) {
            v20 = _products[_products.length + 1 - 1].data;
            v21 = v22 = 0;
            while (v21 < v13.length & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) {
                STORAGE[v20] = MEM[v10.word1 + v18];
                v20 = v20 + 1;
                v18 = v18 + 32;
                v21 = v21 + 32;
            }
            if (v13.length & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 < v13.length) {
                STORAGE[v20] = MEM[v10.word1 + v18] & ~(uint256.max >> ((v13.length & 0x1f) << 3));
            }
            _products[_products.length + 1 - 1].length = (v13.length << 1) + 1;
        } else {
            v23 = v24 = 0;
            if (v13.length) {
                v23 = MEM[v13.data];
            }
            _products[_products.length + 1 - 1].length = v23 & ~(uint256.max >> (v13.length << 3)) | v13.length << 1;
        }
        v25 = v10.word2;
        require(v25.length <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
        v26 = 0x3f0e(_products[_products.length + 1 - 1].length);
        if (v26 > 31) {
            v27 = v28 = _products[_products.length + 1 - 1].data;
            v27 = v29 = v28 + (v25.length + 31 >> 5);
            while (v27 < v28 + (v26 + 31 >> 5)) {
                STORAGE[v27] = STORAGE[v27] & 0x0 | uint256(0);
                v27 = v27 + 1;
            }
        }
        v30 = v31 = 32;
        if (v25.length > 31 == 1) {
            v32 = _products[_products.length + 1 - 1].data;
            v33 = v34 = 0;
            while (v33 < v25.length & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0) {
                STORAGE[v32] = MEM[v10.word2 + v30];
                v32 = v32 + 1;
                v30 = v30 + 32;
                v33 = v33 + 32;
            }
            if (v25.length & 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 < v25.length) {
                STORAGE[v32] = MEM[v10.word2 + v30] & ~(uint256.max >> ((v25.length & 0x1f) << 3));
            }
            _products[_products.length + 1 - 1].length = (v25.length << 1) + 1;
        } else {
            v35 = v36 = 0;
            if (v25.length) {
                v35 = MEM[v25.data];
            }
            _products[_products.length + 1 - 1].length = v35 & ~(uint256.max >> (v25.length << 3)) | v25.length << 1;
        }
        return ;
    } else {
...
function products(uint256 varg0) public nonPayable { 
    ...
    v0 = 0x3f0e(_products[varg0].length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x3f0e(_products[varg0].length);
    if (v4) {
        if (31 < v4) {
            v5 = v6 = _products[varg0].data;
            while (v3 + v4 > v2) {
                MEM[v2] = STORAGE[v5];
                v5 += 1;
                v2 += 32;
            ...
            MEM[v3] = _products[varg0].length >> 8 << 8;
        }
    }
    v7 = 0x3f0e(_products[varg0].length);
    v8 = new bytes[](v7);
    v9 = v10 = v8.data;
    v11 = 0x3f0e(_products[varg0].length);
    if (v11) {
        if (31 < v11) {
            v12 = v13 = _products[varg0].data;
            while (v10 + v11 > v9) {
                MEM[v9] = STORAGE[v12];
                v12 += 1;
                v9 += 32;
...
function getProducts() public nonPayable { 
    ...
    while (v8 < _products.length) {
        ...
        v10 = 0x3f0e(_products[v8].length);
        v11 = new bytes[](v10);
        v12 = v13 = v11.data;
        v14 = 0x3f0e(_products[v8].length);
        if (v14) {
            if (31 < v14) {
                v15 = v16 = _products[v8].data;
                while (v13 + v14 > v12) {
                    MEM[v12] = STORAGE[v15];
                    v15 += 1;
                    v12 += 32;
                ...
                MEM[v13] = _products[v8].length >> 8 << 8;
            }
        }
        require(64 <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
        v17 = new bytes[](64);
        ...
        if (!mapping_1[address(keccak256(MEM[v59a0x2b66.data:v59a0x2b66.data + v59a0x2b66.length]))]) {
            ...
            require(v8 < _products.length, Panic(50)); // access an out-of-bounds or negative index of bytesN array or slice
            v21 = 0x3f0e(_products[v8].length);
            v22 = new bytes[](v21);
            v23 = v24 = v22.data;
            v25 = 0x3f0e(_products[v8].length);
            if (v25) {
                if (31 < v25) {
                    v26 = v27 = _products[v8].data;
                    while (v24 + v25 > v23) {
                        MEM[v23] = STORAGE[v26];
                        v26 += 1;
                        v23 += 32;
                    ...
                    MEM[v24] = _products[v8].length >> 8 << 8;
                }
            }
            v20.word1 = v22;
            require(v8 < _products.length, Panic(50)); // access an out-of-bounds or negative index of bytesN array or slice
            v28 = 0x3f0e(_products[v8].length);
            v29 = new bytes[](v28);
            v30 = v31 = v29.data;
            v32 = 0x3f0e(_products[v8].length);
            if (v32) {
                if (31 < v32) {
                    v33 = v34 = _products[v8].data;
                    while (v31 + v32 > v30) {
                        MEM[v30] = STORAGE[v33];
                        v33 += 1;
                        v30 += 32;
                    ...
                    MEM[v31] = _products[v8].length >> 8 << 8;
                }
            }
            v20.word2 = v29;
            require(v8 < _products.length, Panic(50)); // access an out-of-bounds or negative index of bytesN array or slice
