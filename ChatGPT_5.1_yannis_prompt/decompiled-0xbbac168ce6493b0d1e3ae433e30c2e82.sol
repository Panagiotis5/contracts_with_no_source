    ...
    if (0 - bytes1(varg0)) {
        if (uint248.max + 1 - bytes1(varg0)) {
            ...
            if (v11 < msg.data.length) {
                            ...
                            if (6 - uint8(v13)) {
                                if (15 - uint8(v13)) {
                                    if (16 - uint8(v13)) {
                                        ...
                                        v92 = new bytes[](v93.length);
                                        v94 = v95 = 0;
                                        while (v94 < v93.length) {
                                            v92[v94] = v93[v94];
                                            v94 += 32;
                                        }
                                        v92[v93.length] = 0;
                ...
                v227 = new bytes[](v228.length);
                v229 = v230 = 0;
                while (v229 < v228.length) {
                    v227[v229] = v228[v229];
                    v229 += 32;
                }
                v227[v228.length] = 0;
                ...
                v232 = new bytes[](v233.length);
                v234 = v235 = 0;
                while (v234 < v233.length) {
                    v232[v234] = v233[v234];
                    v234 += 32;
                }
                v232[v233.length] = 0;
                ...
                v238 = new bytes[](v239.length);
                v240 = v241 = 0;
                while (v240 < v239.length) {
                    v238[v240] = v239[v240];
                    v240 += 32;
                }
                v238[v239.length] = 0;
        ...
        if (tx.origin - msg.sender) {
            ...
            if (msg.sender + 0xffffffffffffffffffffffff4444444444633a16f1c4c509b42509d3c8110035) {
                ...
                if (v30 < msg.data.length) {
                                ...
                                if (6 - uint8(v32)) {
                                    if (15 - uint8(v32)) {
                                        if (16 - uint8(v32)) {
                                            ...
                                            v111 = new bytes[](v112.length);
                                            v113 = v114 = 0;
                                            while (v113 < v112.length) {
                                                v111[v113] = v112[v113];
                                                v113 += 32;
                                            }
                                            v111[v112.length] = 0;
                    ...
                    v246 = new bytes[](v247.length);
                    v248 = v249 = 0;
                    while (v248 < v247.length) {
                        v246[v248] = v247[v248];
                        v248 += 32;
                    }
                    v246[v247.length] = 0;
                    ...
                    v251 = new bytes[](v252.length);
                    v253 = v254 = 0;
                    while (v253 < v252.length) {
                        v251[v253] = v252[v253];
                        v253 += 32;
                    }
                    v251[v252.length] = 0;
                    ...
                    v257 = new bytes[](v258.length);
                    v259 = v260 = 0;
                    while (v259 < v258.length) {
                        v257[v259] = v258[v259];
                        v259 += 32;
                    }
                    v257[v258.length] = 0;
