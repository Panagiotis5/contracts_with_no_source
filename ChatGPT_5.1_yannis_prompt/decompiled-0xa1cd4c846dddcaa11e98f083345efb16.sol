...
function token0() public payable { 
    return address(0x2a10d8d17aea89473f010e137de7e9826cc9277f);
}
...
function swap(address recipient, bool zeroForOne, int256 amountSpecified, uint160 sqrtPriceLimitX96, bytes data) public payable { 
    ...
    require(address(0x8f7fe9a930392fc0b0d4491a1c52a0ad6da490df) == this);
    ...
    while (1) {
        ...
        if (!v15) {
            ...
            if (bool(!zeroForOne)) {
                if (v28 < 0) {
                    0x3b86(0 - v28, recipient, 0x2a10d8d17aea89473f010e137de7e9826cc9277f);
                }
                v34 = 0x3e1d();
            ...
            assert(int24(200));
            v45 = v46 = int24(v11.word3) / int24(200);
            v47 = v48 = int24(v11.word3) < 0;
            if (v48) {
                assert(int24(200));
                v47 = bool(int24(int24(v11.word3) % int24(200)));
            }
            if (v47) {
            ...
            if (bool(!zeroForOne)) {
                ...
                if (v51) {
                    ...
                    v53 = v54 = (1 + v45 + uint8(v52 - int24(1 + v45) % (uint8.max + 1))) * 200;
                } else {
                    v53 = v55 = (1 + v45 + uint8(uint8.max - int24(1 + v45) % (uint8.max + 1))) * 200;
                }
            } else {
                ...
                if (v56) {
                    ...
                    v53 = v58 = (v45 - uint8(int24(v45) % (uint8.max + 1) - v57)) * 200;
                } else {
                    v53 = v59 = (v45 - uint8(int24(v45) % (uint8.max + 1))) * 200;
                }
            }
            v44.word2 = bool(v50);
            v44.word1 = int24(v53);
            ...
            if (v11.word0 < v66) {
                ...
                v72 = 0x32d9(10 ** 6, uint24(0xf1b30), v11.word0);
                if (address(v11.word2) >= address(v0)) {
            ...
            if (!v67) {
                v88 = v89 = 0x41a9(uint24(0xf1b30), uint24(10000), v65);
            } else {
...
function 0x3cd4() private { 
    ...
    MEM[v2] = MEM[v0] & ~((uint8.max + 1) ** (32 - v4) - 1) | MEM[v2] & (uint8.max + 1) ** (32 - v4) - 1;
    v5, /* uint256 */ v6, /* uint256 */ v7 = address(0x2a10d8d17aea89473f010e137de7e9826cc9277f).balanceOf(this).gas(msg.gas);
    if (RETURNDATASIZE() == 0) {
        v8 = v9 = 96;
    } else {
...
function flash(address recipient, uint256 amount0, uint256 amount1, bytes data) public payable { 
    ...
    v0 = 0x41a9(10 ** 6, uint24(10000), amount0);
    v1 = 0x41a9(10 ** 6, uint24(10000), amount1);
    v2 = 0x3cd4();
    v3 = 0x3e1d();
    if (amount0) {
        0x3b86(amount0, recipient, 0x2a10d8d17aea89473f010e137de7e9826cc9277f);
    }
    if (amount1) {
...
function 0x4acf(int24 varg0, uint256 varg1, int24 varg2, int24 varg3, uint256 varg4) private { 
    ...
    if (int128(varg1)) {
        ...
        require(uint128(v33) <= uint128(0x762d10ef955d55b7d038c7a7231cc), Error(19535));
        ...
        require(uint128(v40) <= uint128(0x762d10ef955d55b7d038c7a7231cc), Error(19535));
        ...
        if (!_ticks[v32].field0_0_15 != !uint128(v33)) {
            assert(int24(200));
            require(!int24(varg3 % int24(200)));
            assert(int24(200));
            _tickBitmap[int16(int24(varg3 / int24(200)) >> 8)] = _tickBitmap[int16(int24(varg3 / int24(200)) >> 8)] ^ 1 << uint8(int24(varg3 / int24(200)) % (uint8.max + 1));
        }
        if (!_ticks[v39].field0_0_15 != !uint128(v40)) {
            assert(int24(200));
            require(!int24(varg2 % int24(200)));
            assert(int24(200));
            _tickBitmap[int16(int24(varg2 / int24(200)) >> 8)] = _tickBitmap[int16(int24(varg2 / int24(200)) >> 8)] ^ 1 << uint8(int24(varg2 / int24(200)) % (uint8.max + 1));
        }
    }
    v45 = varg3;
    v46 = varg2;
...
function collect(address recipient, int24 tickLower, int24 tickUpper, uint128 amount0Requested, uint128 amount1Requested) public payable { 
    ...
    if (uint128(v0)) {
        ...
        0x3b86(uint128(v0), recipient, 0x2a10d8d17aea89473f010e137de7e9826cc9277f);
    }
    if (uint128(v2)) {
...
function maxLiquidityPerTick() public payable { 
    return uint128(0x762d10ef955d55b7d038c7a7231cc);
}
